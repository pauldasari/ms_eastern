...
Idea: take it further and now say we’re trying to predict one of the variables
...
In Regression, we can use IV/DV language: we are implying causality
...
We’re predicting a specific value for specific person based on our model
...
We’re in the land of linear regression

Our line consists of two things: slope and intercept
Slope = bi
Intercept = b0
These bs are referred to as regression coefficients
You’ll see b, bi, or β
